...
type Failure struct {
	MsgType          *MessageType       `protobuf:"varint,1,opt,name=msg_type,json=msgType,enum=MessageType" json:"msg_type,omitempty"`
	Code             *types.FailureType `protobuf:"varint,2,opt,name=code,enum=FailureType" json:"code,omitempty"`
...
type TransactionSign struct {
	...
	TransactionIn    []*types.SkycoinTransactionInput  `protobuf:"bytes,2,rep,name=transactionIn" json:"transactionIn,omitempty"`
	NbOut            *uint32                           `protobuf:"varint,3,req,name=nbOut" json:"nbOut,omitempty"`
	TransactionOut   []*types.SkycoinTransactionOutput `protobuf:"bytes,4,rep,name=transactionOut" json:"transactionOut,omitempty"`
	XXX_unrecognized []byte                            `json:"-"`
}
...
func (m *TransactionSign) GetTransactionIn() []*types.SkycoinTransactionInput {
	if m != nil {
...
func (m *TransactionSign) GetTransactionOut() []*types.SkycoinTransactionOutput {
	if m != nil {
	...
	for iNdEx < l {
		...
		case 2:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				v |= (types.FailureType(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
	...
	for iNdEx < l {
		...
		case 1:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				v |= (types.ButtonRequestType(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *PinMatrixRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			var v types.PinMatrixRequestType
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowMessages
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				v |= (types.PinMatrixRequestType(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
	...
	for iNdEx < l {
		...
		case 1:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				v |= (types.WordRequestType(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *TransactionSign) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			m.TransactionIn = append(m.TransactionIn, &types.SkycoinTransactionInput{})
		...
		case 4:
			...
			m.TransactionOut = append(m.TransactionOut, &types.SkycoinTransactionOutput{})
...
var fileDescriptorMessages = []byte{
	...
	,
}
